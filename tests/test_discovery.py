...
`heldfast` with no arguments scans the current directory. The README's first
...
from heldfast.discovery import _SKIP_DIRS, discover_config_files  # noqa: E402
...
class TestWhatItRefusesToWalk(unittest.TestCase):
    ...
    def test_a_pruned_name_is_still_scanned_when_named_directly(self) -> None:
        """Only directories *below* a root are pruned. Pointing heldfast at
