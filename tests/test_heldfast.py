...
from heldfast.parsers import parse_config, parse_skill  # noqa: E402
from heldfast.report.sarif import render_sarif  # noqa: E402
from heldfast.rules import AuditContext, run_rules  # noqa: E402
from heldfast.rules.execution import levenshtein, split_package  # noqa: E402
from heldfast.rules.poisoning import invisible_runs  # noqa: E402
from heldfast.secrets import redact  # noqa: E402
from heldfast import suppressions  # noqa: E402
...
def scan_dir(path: Path, *, skills: bool = True) -> list[Finding]:
    ...
    from heldfast.parsers import discover_skills
...
class TestCleanCorpus(unittest.TestCase):
    ...
    def test_env_indirection_is_not_a_secret(self) -> None:
        from heldfast.rules.credentials import classify_secret
...
class TestLockfileAndDrift(unittest.TestCase):
    ...
    def test_legacy_lockfile_is_used_when_the_new_name_is_absent(self) -> None:
        from heldfast.lockfile import resolve_lock_path
        with tempfile.TemporaryDirectory() as tmp:
            cwd = Path(tmp)
...
class TestSuppressions(unittest.TestCase):
    ...
    def test_cli_reports_rather_than_hides(self) -> None:
        ...
        r = subprocess.run(
            [sys.executable, "-m", "heldfast", "scan", "tests/fixtures/vulnerable",
...
class TestSarif(unittest.TestCase):
    def test_shape(self) -> None:
        ...
        run = doc["runs"][0]
        self.assertEqual("heldfast", run["tool"]["driver"]["name"])
...
class TestCli(unittest.TestCase):
    ...
    def test_json_output_parses(self) -> None:
        ...
        doc = json.loads(r.stdout)
        self.assertEqual("heldfast", doc["tool"])
...
class TestRealWorldRegressions(unittest.TestCase):
    ...
    def test_single_label_hostname_counts_as_private(self) -> None:
        ...
        from heldfast.rules.transport import is_private
